...
const prefix = "$"
const lineLink = "https://media.discordapp.net/attachments/1236395855855226890/1242903762520113182/tu.png.webp?ex=664f87d5&is=664e3655&hm=755abca3dcf9078d4dab60d19f95589840c7c78ab9bc0e79351000eed47cb216&=&format=webp&width=662&height=28"
...
client.on('messageCreate', async (message) => {
  if (message.content.startsWith(prefix + 'come')) {
    if (message.author.bot) return;
    if (!message.member.roles.cache.has('1152236106973196370')) return; // ايدي الرتبة الي تقدر تستعمل الامر
...
client.on('messageCreate', async (message) => {
  if (message.content.startsWith(prefix + 'خمول')) {
    if (message.author.bot) return;
    if (!message.member.roles.cache.has('1152236106973196370')) return; // ايدي الرتبة الي تقدر تستعمل الامر
    if (!message.member.permissions.has('ADMINISTRATOR')) return;
    ...
    user.send(`**سيتم اغلاق التيكيت ان لم تاتي<#${message.channel.id}> \nFor ${user}**`);
...
client.on("ready", () => {
    client.user.setPresence({
        status: 'idle',//idle|online|dnd
        activities: [{
            name: `elite`,
            type: "STREAMING", url: "https://www.twitch.tv/po7f1"
        }]
    })
})
client.on("messageCreate", message => {
if (message.content == "خط"){
  message.reply("https://media.discordapp.net/attachments/1236395855855226890/1242903762520113182/tu.png.webp?ex=664f87d5&is=664e3655&hm=755abca3dcf9078d4dab60d19f95589840c7c78ab9bc0e79351000eed47cb216&=&format=webp&width=662&height=28")
}})
